...
export const insertPlayerSchema = z.object({
  nickname: z.string().min(3).max(20).refine(
    (val) => !/^\d/.test(val),
    { message: "Nickname cannot start with a number" }
  ),
});
...
export const levels: Level[] = [
  ...
  {
    id: 11,
    name: "AI Security Challenge",
    nameUa: "ШІ Виклик безпеки",
    description: "Solve an AI-generated security challenge",
    descriptionUa: "Вирішіть згенерований ШІ виклик безпеки",
    vulnerability: "AI Challenge",
    category: "AI Security",
    basePoints: 160,
    simulationType: "ai-challenge",
    objective: "Analyze the AI-generated scenario and find the security vulnerability",
    objectiveUa: "Проаналізуйте згенерований ШІ сценарій та знайдіть вразливість безпеки",
    solution: "AI_VERIFIED",
    explanation: {
      what: "AI-powered security challenges help you practice identifying vulnerabilities in dynamic, realistic scenarios that adapt to your skill level.",
      whatUa: "ШІ-генеровані виклики безпеки допомагають практикуватися у виявленні вразливостей у динамічних, реалістичних сценаріях, що адаптуються до вашого рівня.",
      how: "You analyzed the AI-generated scenario and correctly identified the security vulnerability based on your cybersecurity knowledge.",
      howUa: "Ви проаналізували згенерований ШІ сценарій та правильно ідентифікували вразливість безпеки на основі ваших знань з кібербезпеки.",
      defense: "Always stay updated with the latest security threats, practice regularly with diverse scenarios, and develop a systematic approach to security analysis.",
      defenseUa: "Завжди слідкуйте за останніми загрозами безпеки, регулярно практикуйтесь з різноманітними сценаріями та розвивайте системний підхід до аналізу безпеки."
    },
    isAIGenerated: true,
    requiredInputs: 1
  },
  {
    id: 12,
    name: "Advanced AI Security Challenge",
    nameUa: "Розширений ШІ Виклик",
    description: "Solve an advanced AI challenge requiring multiple steps",
    descriptionUa: "Вирішіть розширений ШІ виклик, що потребує декількох кроків",
    vulnerability: "Multi-Step Attack",
    category: "AI Security",
    basePoints: 200,
    simulationType: "ai-multi-challenge",
    objective: "Complete a two-step security challenge generated by AI",
    objectiveUa: "Виконайте двокроковий виклик безпеки, згенерований ШІ",
    solution: "AI_VERIFIED",
    explanation: {
      what: "Advanced multi-step attacks require chaining multiple vulnerabilities together. This simulates real-world attack scenarios.",
      whatUa: "Розширені багатокрокові атаки вимагають поєднання кількох вразливостей. Це симулює реальні сценарії атак.",
      how: "You successfully completed both steps of the attack chain, demonstrating understanding of how vulnerabilities can be combined.",
      howUa: "Ви успішно виконали обидва кроки ланцюжка атаки, демонструючи розуміння того, як можна комбінувати вразливості.",
      defense: "Implement defense-in-depth strategies, assume any single control can be bypassed, and monitor for attack chains.",
      defenseUa: "Впроваджуйте стратегії глибокого захисту, припускайте, що будь-який окремий контроль можна обійти, та моніторте ланцюжки атак."
    },
    isAIGenerated: true,
    requiredInputs: 2
  }
...
export const achievements: Achievement[] = [
  ...
  { id: "cyber-warrior", name: "Cyber Warrior", nameUa: "Кібер-воїн", description: "Complete all 12 levels", descriptionUa: "Завершіть усі 12 рівнів", icon: "Shield", condition: "complete_12" },
